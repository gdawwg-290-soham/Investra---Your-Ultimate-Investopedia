      ...
      <nav>
        <Container className="relative z-50 flex justify-between py-8">
          ...
          <div className="flex items-center gap-6">
            <Button href="https://gmail.com" variant="outline" className="hidden lg:block">
              Get Advice
            </Button>
            <Button href="https://www.linkedin.com/in/soham-ghosh-6a5202223/" className="hidden lg:block">
              Hire me
            </Button>
            <Button href="https://react-fire-base-chat-app.vercel.app/" variant="outline" className="hidden lg:block">
                Have a Chat?
            </Button>
            {/* Mobile NavLinks */}
                      ...
                      <>
                        ...
                        >
                          ...
                          <div className="mt-8 flex flex-col gap-4">
                           <Button href="https://gmail.com" variant="outline">
                            Get Advice
                           </Button>
                           <Button href="https://www.linkedin.com/in/soham-ghosh-6a5202223/">
                            Hire me
                           </Button>
                           <Button href="https://react-fire-base-chat-app.vercel.app/" variant="outline">
                            Have a Chat?
                           </Button>
                          </div>
                        </Popover.Panel>
